...
sendClientCommand clientCommand =
  let json = encodeClientCommand clientCommand
      ...
      case serverCommand of
        ...
        Echo echo ->
          case model of
            ...
            _ -> (model, Cmd.none) -- or what? show an error?
    ServerError ->
      (model, Cmd.none) -- could consider displaying it on the client?
    SuspectLogin ->
